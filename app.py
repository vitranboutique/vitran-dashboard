    ...
    with st.expander("📦 Báo cáo tồn kho + kiểm kê (in A4)", expanded=False):
        ...
        if not _rows:
            ...
            _css = ("*{box-sizing:border-box}"
                    ...
                    "align-items:flex-end;border-bottom:2.5px solid #111;padding-bottom:6px;margin-bottom:8px}"
                    ...
                    ".foot{font-size:11px;color:#666;margin-top:7px}.ncc{font-size:10px;color:#0a7a55}"
                    ...
                    "th,td{border:1px solid #999;padding:4px 6px;overflow-wrap:anywhere;line-height:1.25}"
