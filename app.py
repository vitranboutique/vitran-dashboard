...
@st.cache_data(ttl=30, show_spinner=False)   # clip khui mới phải lên A4 gần như ngay; API v2 lấy tối đa 1000/video request
...
def _render_daily():
    ...
    st.caption("Tổng hợp tự động từ Sapo + Dohana — bấm **In báo cáo A4** trong khung để in/lưu PDF.  "
               "🎥 *Clip nhập hàng hoàn tự cập nhật khoảng 30 giây; bấm “Tải lại số liệu” để cập nhật ngay.*")
